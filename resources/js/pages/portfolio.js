				...
				<div
					...
					<center>
						...
						<div className="d-flex justify-content-center">
							<div className="mx-2 px-2 p-1 border-bottom border-light">
								<h6 className="text-light">Pictures</h6>
							</div>
							<div className="mx-2 px-2 p-1">
								<h6 className="text-light">Videos</h6>
							</div>
						</div>
						<div className="d-flex justify-content-center">
							<div
								className={`m-2 px-2 p-1 ${
							...
							<div
								className={`m-2 px-2 p-1 ${
									active == `Wedding` && `border-bottom border-light`
								}`}
								style={{ cursor: "pointer", transition: "border 3s ease-out" }}
							...
							<div
								className={`m-2 px-2 p-1 ${
									active == `Portrait` && `border-bottom border-light`
								}`}
								style={{ cursor: "pointer", transition: "border 3s ease-out" }}
							...
							<div
								className={`m-2 px-2 p-1 ${
									active == `Kid` && `border-bottom border-light`
								}`}
								style={{ cursor: "pointer", transition: "border 3s ease-out" }}
			...
			<section
				...
				<div className="container-fluid">
					<div className="row sonar-portfolio">
						{/* <!-- Single gallery Item --> */}
						<div
							className="col-12 col-sm-6 col-lg-3 single_gallery_item portraits wow fadeInUpBig"
							data-wow-delay="500ms">
							<a
								className="gallery-img"
								href="img/portfolio-img/IMG_20210407_211730_563.jpg">
								<img
									src="img/portfolio-img/IMG_20210407_211730_563.jpg"
									loading="lazy"
									alt=""
								/>
							</a>
						...
						{/* <!-- Single gallery Item --> */}
						<div
							className="col-12 col-sm-6 col-lg-3 single_gallery_item landscapes studio wow fadeInUpBig"
							data-wow-delay="300ms">
							<a
								className="gallery-img"
								href="img/portfolio-img/IMG_20210218_143829_548.jpg">
								<img
									src="img/portfolio-img/IMG_20210218_143829_548.jpg"
									loading="lazy"
									alt=""
								/>
							</a>
						...
						{/* <!-- Single gallery Item --> */}
						<div
							className="col-12 col-sm-6 col-lg-3 single_gallery_item product wow fadeInUpBig"
							data-wow-delay="500ms">
							<a
								className="gallery-img"
								href="img/portfolio-img/IMG_20210403_150159_526.jpg">
								<img
									src="img/portfolio-img/IMG_20210403_150159_526.jpg"
									loading="lazy"
									alt=""
								/>
							</a>
						...
						<div
							...
							<a
								className="gallery-img"
								href="img/portfolio-img/IMG_20210406_214053_685.jpg">
								<img
									src="img/portfolio-img/IMG_20210406_214053_685.jpg"
									loading="lazy"
									alt=""
								/>
							</a>
						...
						{/* <!-- Single gallery Item --> */}
						<div
							className="col-12 col-sm-6 col-lg-3 single_gallery_item landscapes product wow fadeInUpBig"
							data-wow-delay="300ms">
							<a
								className="gallery-img"
								href="img/portfolio-img/IMG_20210329_214826_974.jpg">
								<img
									src="img/portfolio-img/IMG_20210329_214826_974.jpg"
									loading="lazy"
									alt=""
								/>
							</a>
						...
						<div
							...
							<a
								className="gallery-img"
								href="img/portfolio-img/IMG_20210327_142635_314.jpg">
								<img
									src="img/portfolio-img/IMG_20210327_142635_314.jpg"
									loading="lazy"
									alt=""
								/>
							</a>
						...
						<div
							...
							<a
								className="gallery-img"
								href="img/portfolio-img/IMG_20210330_165116_110.jpg">
								<img
									src="img/portfolio-img/IMG_20210330_165116_110.jpg"
									loading="lazy"
									alt=""
								/>
							</a>
						...
						{/* <!-- Single gallery Item --> */}
						<div
							className="col-12 col-sm-6 col-lg-3 single_gallery_item portraits studio wow fadeInUpBig"
							data-wow-delay="900ms">
							<a
								className="gallery-img"
								href="img/portfolio-img/IMG_20210330_204636_605.jpg">
								<img
									src="img/portfolio-img/IMG_20210330_204636_605.jpg"
									loading="lazy"
									alt=""
								/>
							</a>
						...
						<div
							...
							<a
								className="gallery-img"
								href="img/portfolio-img/IMG_20210329_143557_416.jpg">
								<img
									src="img/portfolio-img/IMG_20210329_143557_416.jpg"
									loading="lazy"
									alt=""
								/>
							</a>
						...
						<div
							...
							<a
								className="gallery-img"
								href="img/portfolio-img/IMG_20210328_220224_702.jpg">
								<img
									src="img/portfolio-img/IMG_20210328_220224_702.jpg"
									loading="lazy"
									alt=""
								/>
							</a>
						...
						{/* <!-- Single gallery Item --> */}
						<div
							className="col-12 col-sm-6 col-lg-3 single_gallery_item landscapes wow fadeInUpBig"
							data-wow-delay="700ms">
							<a
								className="gallery-img"
								href="img/portfolio-img/IMG_20210329_162511_163.jpg">
								<img
									src="img/portfolio-img/IMG_20210329_162511_163.jpg"
									loading="lazy"
									alt=""
								/>
							</a>
						...
						<div
							...
							<a
								className="gallery-img"
								href="img/portfolio-img/IMG_20210330_122032_932.jpg">
								<img
									src="img/portfolio-img/IMG_20210330_122032_932.jpg"
									loading="lazy"
									alt=""
								/>
							</a>
